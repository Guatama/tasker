...
CHARCOUNT_CASES = [
    Case(name='charcount',
              ...
              params={},
              result={"result": {
                                "msg": "char_count() missing 1 required positional argument: 'text'",
                                "status": "ERROR"}
                    }),
    Case(name='charcount',
              json_schema=None,
              params={"msg": 0},
              result={"result": {
                                "msg": "char_count() got an unexpected keyword argument 'msg'",
                                "status": "ERROR"}
                    }),
    Case(name='charcount',
              json_schema=None,
...
MANYARG_CASES = [
    Case(name='manyarg',
              ...
              params={},
              result={"result": {
                                "msg": "run() missing 7 required positional arguments: 'a', 'b', 'c', 'd', 'e', 'f', and 'g'",
                                "status": "ERROR"}
                    }),
    Case(name='manyarg',
              json_schema=None,
              params={"a": 5, "g": 10, "c": 12, "e": 5},
              result={"result": {
                                "msg": "run() missing 3 required positional arguments: 'b', 'd', and 'f'",
                                "status": "ERROR"}
                    }),
    Case(name='manyarg',
              json_schema=None,
    ...
    Case(name='mult',
              json_schema={'type': 'object',
                   'properties': {
                    ...
                    'required': ['operands']},
              params={},
              result={"msg": "'operands' is a required property", "status": "ValidationError"}),
    Case(name='mult',
              json_schema={'type': 'object',
                   'properties': {
                       'operands': {
                    ...
                    'required': ['operands']},
              params={"operands": 0},
              result={"msg": "0 is not of type 'array'", "status": "ValidationError"}),
    Case(name='mult',
              json_schema={'type': 'object',
                   'properties': {
                       'operands': {
                    ...
                    'required': ['operands']},
              params={"operands": []},
              result={"msg": "[] is too short", "status": "ValidationError"}),
    Case(name='mult',
              json_schema={'type': 'object',
                   'properties': {
                       'operands': {
                    ...
                    'required': ['operands']},
              params={"operands":["a"]},
              result={"msg": "'a' is not of type 'number'", "status": "ValidationError"}),
    Case(name='mult',
              json_schema={'type': 'object',
                   'properties': {
                       'operands': {
                    ...
                    'required': ['operands']},
              params={"operands": [x for x in range(1, 101)]},
              result={"result": 93326215443944152681699238856266700490715968264381621468592963895217599993229915608941463976156518286253697920827223758251185210916864000000000000000000000000}),
]

MULTIPRINT_CASES = [
    Case(name='multiprint',
              json_schema=None,
              params={},
              result={"result": {
                                "msg": "multi_print() missing 1 required positional argument: 'msg'",
                                "status": "ERROR"}}),
    Case(name='multiprint',
              json_schema=None,
              params={"msg": "test"},
    ...
    Case(name='multiprint',
              json_schema=None,
              params={"msg": "test", "count": 1},
              result={"result": "test"}),
    Case(name='multiprint',
              json_schema=None,
              params={"msg": "test", "count": 0},
              result={"result": ""})
